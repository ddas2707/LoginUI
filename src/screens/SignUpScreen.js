        ...
        <SafeAreaView style={{ flex: 3, backgroundColor: '#836FFF' }}>
            <View style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                <View style={styles.icons}>
                    <LottieView style={{ height: 250 }} source={require('../assets/Login.json')} autoPlay loop />
                </View>
            ...
            <View style={{ flex: 2.2, backgroundColor: '#fff', borderTopLeftRadius: 40, borderTopRightRadius: 40 }}>

                {/* <Text style={{ paddingHorizontal: 70, paddingTop: 30, color: 'black', fontSize: 16 }}>Full Name</Text>
                <TextInput
                    style={styles.email}
                    placeholder='John'
                    value={name}
                ...
                <View>
                    ...
                    >
                        <Text style={{ color: 'black', fontSize: 17, fontWeight: 700 }}>Sign Up</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
                    <Text style={{ color: 'black', textAlign: 'center', fontSize: 16, fontWeight: '600' }}>Already have an Account ?</Text>
                    <TouchableOpacity onPress={() => navigation.navigate('Login')}>
                        <Text style={{ color: '#FFD700', textAlign: 'center', fontSize: 16, fontWeight: '600' }} > Login</Text>
                    </TouchableOpacity>
                </View>
